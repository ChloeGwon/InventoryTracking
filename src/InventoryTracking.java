...
public class InventoryTracking {
	...
	public static void main(String[] args) throws IOException {
		...
		int itemCount = 0;
		String name, category, quantity, warehouseLocation;
		...
		while (option != 'Q' || option != 'q') {
			...
			if (option == 'A' || option == 'a') {
				...
				if (location == 'O' || location == 'o') {
					...
					itemExisted(input, name, warehouseLocation, inventory, QTT, category, warehouseArrList);
					if (!itemExisted(input, name, warehouseLocation, inventory, QTT, category, warehouseArrList)) {
						addToInventory(name, category, QTT, warehouseLocation, inventory, warehouseArrList);
					}
				}
	...
	public static void addToInventory(String name, String category, String QTT, String warehouseLocation, Inventory inventory, 
			ArrayList<String> warehouseArrList) throws IOException {
	
		inventory = new Inventory(name, category, QTT, warehouseLocation);
		warehouseArrList.add(inventory.toString());
		
		try {
			FileWriter file = new FileWriter("Inventory.csv", true);
			PrintWriter outFile = new PrintWriter(file);
			outFile.println(inventory.toString());
	...
	public static boolean itemExisted(Scanner input, String name, String warehouseLocation, Inventory inventory, String QTT, 
	...
	public static void updateToInventory(Scanner input, String name, ArrayList<String> warehouseArrList, String searchLocation) throws IOException {
		...
		if (option.equals("N") || option.equals("n")) {
			...
			warehouseArrList.set(index, itemValues[0]+","+itemValues[1]+","+quantity+","+itemValues[3]);
		}
